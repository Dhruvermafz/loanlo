  ...
  const data = [
    {
      ...
      onChange: (value) => {
        handleAmountChange(value, setAmount, setErrors);
      },
      icon: "",
      error: errors.amount,
    },
    {
      ...
      onChange: (value) => {
        handleDateChange(value, setStart, setErrors);
      },
      icon: "",
      error: errors.date,
    },
    {
      ...
      onChange: (value) => {
        handleEmiChange(value, setEmi, setErrors);
      },
      icon: "",
      error: errors.emi,
    },
